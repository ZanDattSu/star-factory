...
// PaymentMethodToProto конвертирует service PaymentMethod → proto PaymentMethod.
...
// PaymentMethodToModel конвертирует proto PaymentMethod → service PaymentMethod.
