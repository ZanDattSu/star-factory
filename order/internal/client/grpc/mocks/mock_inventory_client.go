...
// ListParts provides a mock function with given fields: ctx, partsFilter
func (_m *InventoryClient) ListParts(ctx context.Context, partsFilter model.PartsFilter) ([]*model.Part, error) {
	ret := _m.Called(ctx, partsFilter)
...
func (_e *InventoryClient_Expecter) ListParts(ctx interface{}, partsFilter interface{}) *InventoryClient_ListParts_Call {
	return &InventoryClient_ListParts_Call{Call: _e.mock.On("ListParts", ctx, partsFilter)}
}

func (_c *InventoryClient_ListParts_Call) Run(run func(ctx context.Context, partsFilter model.PartsFilter)) *InventoryClient_ListParts_Call {
